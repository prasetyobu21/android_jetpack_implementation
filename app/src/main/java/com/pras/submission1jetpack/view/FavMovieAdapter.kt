...
class FavMovieAdapter() :
    PagedListAdapter<MovieListEntity, FavMovieAdapter.MovieViewHolder>(DIFF_CALLBACK) {
    ...
    private var onItemClickCallback: FavMovieAdapter.OnItemClickCallback? = null
