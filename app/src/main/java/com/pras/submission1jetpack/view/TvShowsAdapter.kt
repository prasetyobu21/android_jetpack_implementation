...
class TvShowsAdapter :
    PagedListAdapter<TvListEntity, TvShowsAdapter.TvShowsViewHolder>(DIFF_CALLBACK) {
    ...
    inner class TvShowsViewHolder(private val binding: MovieListItemBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TvShowsViewHolder {
        ...
        return TvShowsViewHolder(movieListItemBinding)
    }
