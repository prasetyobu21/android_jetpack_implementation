...
class FakeTvRepo(private val remoteDataSource: RemoteDataSource,
private val localDataSource: LocalDataSource,
private val appExecutors: AppExecutors): TvListDataSource {
    ...
    override fun getTvDetail(id: Int): LiveData<Resource<TvListEntity>> {
        return object : NetworkBoundResource<TvListEntity, TvListResponse>(appExecutors) {
            ...
            override fun createCall(): LiveData<ApiResponse<TvListResponse>> = remoteDataSource.getTvDetail(id)
